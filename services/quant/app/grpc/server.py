...
EXECUTION_SERVICE_NAME = "fx.quant.v1.ExecutionService"
_GRACE_SECONDS = 5.0
...
class GrpcServer:
    ...
    def __init__(self, port: int) -> None:
        ...
        quant_pb2_grpc.add_ExecutionServiceServicer_to_server(ExecutionServicer(), self._server)
    ...
    async def start(self) -> None:
        ...
        for name in ("", QUANT_SERVICE_NAME, EXECUTION_SERVICE_NAME):
